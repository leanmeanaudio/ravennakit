...
- Make streaming work on Linux.
- Update awesom-doxygen.
- Move fmt::formatter<rav::PathMatcher::Error> before its being used
...
- Make the codebase open source under AGPLv3 and a commercial license.

## [v0.20.0] - November 24, 2025

### Added

- A method to RavennaSender and RavennaNode to get the SDP for a sender.

### Fixed

- Audio conversions from floating point to integer are now clipped to [-1, 1].
